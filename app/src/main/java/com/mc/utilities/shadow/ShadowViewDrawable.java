package com.mc.utilities.shadow;
...
//            drawRect = new RectF(0, 0, width, height - shadowOffset);
            ...
            int left = (shadowSide) == ShadowProperty.LEFT ? shadowOffset : 0;
            int top = (shadowSide) == ShadowProperty.TOP ? shadowOffset : 0;
            int right = width - ((shadowSide) == ShadowProperty.RIGHT ? shadowOffset : 0);
            int bottom = height - ((shadowSide) == ShadowProperty.BOTTOM ? shadowOffset : 0);
