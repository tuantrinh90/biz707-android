...
public class ExpandableCardViewSubTitle extends LinearLayout {
    ...
    public ExpandableCardViewSubTitle(Context context) {
        super(context);
    }

    public ExpandableCardViewSubTitle(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public ExpandableCardViewSubTitle(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context) {
        ...
        inflater.inflate(R.layout.expandable_cardview_sub, this);
...
//        }
    ...
    public void setFontTitle(boolean isFont) {
        if (isFont) {
