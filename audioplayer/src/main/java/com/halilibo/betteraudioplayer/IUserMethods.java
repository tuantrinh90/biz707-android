...
interface IUserMethods {
    ...
    void setCallback(@NonNull BetterAudioCallback callback);

    void setProgressCallback(@NonNull BetterAudioProgressCallback callback);
     ...
     */
    void setButtonDrawable(@BetterAudioPlayer.LoadingStyle int type, @NonNull Drawable drawable);
     ...
     */
    void setLoadingStyle(@BetterAudioPlayer.LoadingStyle int style);
