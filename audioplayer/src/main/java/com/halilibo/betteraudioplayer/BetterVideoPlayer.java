...
import com.halilibo.betteraudioplayer.utility.video.EmptyCallback;
...
public class BetterVideoPlayer extends RelativeLayout implements IUserMethods1,
...
//    }
    ...
    public void onCompletion(MediaPlayer mediaPlayer) {
        ...
        if (mCallback != null)
            mCallback.onCompletion(this, isReplay);
    }
...
//        mLabelDuration.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.btnPlayPause) {
            ...
            if (mProgressBar.getVisibility() == VISIBLE) return;
            if (isFullScreen) {
                isFullScreen = false;
                if (mCallback != null)
                    mCallback.onFullScreen(true);
                mBtnFullscreen.setImageDrawable(getResources().getDrawable(R.drawable.ic_zoom_in));
            } else {
                isFullScreen = true;
                if (mCallback != null)
                    mCallback.onFullScreen(false);
                mBtnFullscreen.setImageDrawable(getResources().getDrawable(R.drawable.ic_zoom_out));
            }
    ...
    private static void LOG(String message, Object... args) {
        ...
        Log.d("BetterAudioPlayer", message);
    }
